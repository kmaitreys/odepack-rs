...
pub extern "C" fn fake_jacobian_dlsodes(
    _neq: &c_int,
    _t: &c_double,
    _y: *mut c_double,
    _j: &c_int,
    ...
    F: Fn(&[f64], &f64) -> Vec<f64>,
{
    ...
    let call: &extern "C" fn(*const i32, *const f64, *mut f64, *mut f64) -> () =
        unsafe { mem::transmute(closure.code_ptr()) };
